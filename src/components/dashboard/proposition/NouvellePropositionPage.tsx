        ...
        <div className="space-y-6">
          ...
          <section className="rounded-lg border border-zinc-800 bg-zinc-900/70 p-4">
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-zinc-700 pb-2">
              ...
              <button
                type="button"
                onClick={addTarif}
                className="inline-flex items-center gap-1 border border-indigo-600 bg-indigo-600/90 px-3 py-1.5 font-mono text-[10px] uppercase text-white hover:bg-indigo-500"
              >
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              disabled={busy !== "idle"}
              className="inline-flex items-center gap-2 border border-indigo-500 bg-indigo-600 px-4 py-2 font-mono text-[11px] uppercase tracking-widest text-white hover:bg-indigo-500 disabled:opacity-50"
            >
              {busy === "saving"
                ? "Création..."
                : propositionId
            ...
            <button
              ...
              disabled={busy !== "idle"}
              className="inline-flex items-center gap-2 border border-zinc-700 bg-zinc-900 px-4 py-2 font-mono text-[11px] uppercase tracking-widest text-zinc-200 hover:bg-zinc-800 disabled:opacity-50"
            >
            ...
            {propositionId ? (
              <button
                ...
                className="inline-flex items-center gap-2 border border-red-700/60 px-4 py-2 font-mono text-[11px] uppercase text-red-300 hover:bg-red-900/30"
              >
                Supprimer
              </button>
            ) : null}
