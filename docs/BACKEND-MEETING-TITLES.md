...
1. Valider `title` sur `POST /meetings` et `PATCH /meetings/:id` : une des 3 valeurs ci-dessus.
2. Les RDV legacy avec un autre titre restent lisibles ; à l’update, forcer une des 3 valeurs.
